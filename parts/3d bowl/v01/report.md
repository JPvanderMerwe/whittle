...
| | |
|---|---|
| Envelope | 150.00 x 150.00 x 100.00 mm |
| Volume | 228.812 cm3 |
| Watertight | yes |
| Separate bodies | 1 |
| Triangles | 15524 |
...
Roughly **290.6 g** / **95.1 m** of 1.75 mm PETG at 100% infill.
...
| Underside past 45 deg | 463.0 mm2 |
| ...bridged by the layer above | 0.0 mm2 |
| ...falling further | 463.0 mm2 |
| Bed contact | 22332.0 mm2 |
...
- **entrance_height_mm** = 69.0 mm above the floor
...
Spec written by **qwen2.5-coder:7b** on machine **laptop**, 1 attempt(s), 30.4s.
